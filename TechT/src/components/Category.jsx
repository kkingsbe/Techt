    ...
    return (
        <div className="w-full">
            ...
            <div className="grid grid-cols-3 gap-10 ml-auto mr-auto mt-10 w-[60%]">
                ...
                <ArticleCard title={"Ultimate GPS Module"} description={"How to use the Adafruit Ultimate GPS Module with an Arduino."}></ArticleCard>
                <ArticleCard title={"WS2812B LED"} description={"Learn how to control WS2812B LED's from an Arduino and create non-blocking animations."}></ArticleCard>
